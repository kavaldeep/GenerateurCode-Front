      ...
      <div>
        ...
        >
          <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            ...
            <div className="absolute bottom-0 justify-center w-full space-y-2 font-extrabold">
              <button
                onClick={() => {
                  localStorage.removeItem("jwt");
                  window.location.reload();
                }}
                className="flex items-center p-2 text-red-500 rounded-lg dark:text-white hover:bg-gray-50 dark:hover:bg-gray-700"
              >
                <svg
                  fill="none"
                  stroke="currentColor"
        ...
        <div className="sm:ml-64">
          {title !== "Home" && (
            <div className="bg-gray-50 w-full p-5">
              <Breadcrumbs from="Home" to={title} />
            </div>
          )}
          {children}
        </div>
